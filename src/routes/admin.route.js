...
import { getStudentsLaundryRequestsSorted, updateLaundryStatus } from "../controllers/laundryAdmin.controllers.js";
...
adminRouter.route('/updateLaundryStatus').post(adminVerifyJWT,authorizeRoles("LaundryPerson"),updateLaundryStatus);
